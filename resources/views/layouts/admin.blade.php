...
<body>
  ...
  <div class="sb" id="sb">
    ...
    <nav class="sb-nav">
      ...
      <a href="{{ route('admin.sertifikasi.index') }}" class="sb-a {{ request()->routeIs('admin.sertifikasi.*') ? 'active' : '' }}" style="padding-left:36px;font-size:12.5px">
        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg>
        Sertifikasi
      </a>
